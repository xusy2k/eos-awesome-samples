...
// NoteChainView component
class NoteChainView extends Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  render() {
    ...
    let noteCards = noteTable.map((row, i) => generateCard(i, row.timestamp, row.user, row.note));
      ...
      <div>
        ...
        <Paper className={classes.paper}>
          <form onSubmit={this.handleFormEvent}>
            <TextField name="account" autoComplete="off" label="Account" margin="normal" fullWidth />
            <TextField name="privateKey" autoComplete="off" label="Private key" margin="normal" fullWidth />
            <TextField
              name="note"
              autoComplete="off"
              label="Note (Optional)"
...
export default withStyles(styles)(NoteChainView);
